      ...
      <div className="">
         <div className=" bg-blue-800 mt-20">
            <div className="max-w-5xl mx-auto text-center py-4">
               <h1 className="text-9xl text-white font-bold">SEF-2024</h1>
               <span className=" text-3xl text-white font-bold ">
                  SUATAINABLE ENERGY FORUM
               </span>
            </div>
         </div>
         <div className="max-w-5xl mx-auto text-center pt-2">
            <span className=" text-blue-500 text-3xl font-bold ">
               SUATAINABLE ENERGY SECURITY,
            </span>
         ...
         <div className=" pt-3">
            <h1 className="text-center text-2xl text-white font-bold bg-blue-800 py-3">
